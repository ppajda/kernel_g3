...
static int max14688_read_mic_impedence (struct device *dev)
{
	...
	rc = qpnp_vadc_read(input_vadc, P_MUX7_1_1, &result);
	if (rc < 0) {
		if (rc == -ETIMEDOUT) {
